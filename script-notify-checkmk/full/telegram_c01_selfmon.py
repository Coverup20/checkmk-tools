#!/usr/bin/env python3
"""
telegram_c01_selfmon - Telegram self-monitoring notification script for customer C01.
...
CHAT_ID = os.environ.get("TELEGRAM_C01_SELFMON_CHAT_ID", "")
...
def main() -> int:
    if not TOKEN:
        ...
        return 0
    if not CHAT_ID:
        print("ERROR: TELEGRAM_C01_SELFMON_CHAT_ID not set", file=sys.stderr)
        return 0
    ...
    msg = f"[{CUSTOMER_NAME} SELF-MONITOR] {msg}"
